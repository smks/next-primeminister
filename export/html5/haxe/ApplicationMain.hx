...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/bg.jpg");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/boris.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/game.psd");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/images/gove.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/may.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/music/cancan.mp3");
		types.push (lime.Assets.AssetType.MUSIC);
		
		
		urls.push ("assets/music/cancan.ogg");
